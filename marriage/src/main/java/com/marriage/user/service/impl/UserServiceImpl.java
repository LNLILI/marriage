...
public class UserServiceImpl implements UserService {
	...
	public List<User> userLogin(Map<String, Object> map) {
		List<User> user = userDao.userLogin(map); 
	...
	@Override
	public List<User> logindown(Map<String, Object> map) {
		List<User> user = userDao.logindown(map); 
	...
	@Override
	public Integer selectManInformationByTotal(Map<String, Object> map) {
		// TODO Auto-generated method stub
